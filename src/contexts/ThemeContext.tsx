...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({children}) => {
    ...
    useEffect(() => {
        ...
        root.style.setProperty('--content-type-gradient', themeColors.contentTypeGradient || 'linear-gradient(135deg, #10b981 0%, #14b8a6 100%)');
        root.style.setProperty('--language-gradient', themeColors.languageGradient || 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)');
        
        root.style.setProperty('--verb-mode-gradient', themeColors.verbModeGradient || 'linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%)');
    }, [themeColors]);
