...
describe("ModeToggle", () => {
  it("should render both practice and test buttons", () => {
    render(<ModeToggle mode="practice" onModeChange={() => {}} />);
  ...
  it("should call onModeChange when clicking practice", () => {
    ...
    render(<ModeToggle mode="test" onModeChange={handleModeChange} />);
  ...
  it("should call onModeChange when clicking test", () => {
    const handleModeChange = vi.fn();
    render(<ModeToggle mode="practice" onModeChange={handleModeChange} />);
  ...
  it("should disable inactive button in certain conditions", () => {
    render(
      <ModeToggle mode="practice" onModeChange={() => {}} disabled={true} />,
    );
